        ...
        <div className="grid grid-cols-1 lg:grid-cols-[424px_1fr] gap-10 items-start bg-white">
          ...
          <article className="px-6 sm:px-12 lg:px-20 py-10 lg:py-16 ">
            ...
            <ul className="text-primary-600 mt-4">
                <li>Krea Elektronik Hiz. San. Dış Tic. Ltd. Şti.</li>
                <li>Kadıköy İstanbul</li>
            </ul>

            <div className="flex flex-row gap-4 mt-4">
                <span className="text-primary-600">Telefon</span>
                               <Link href="tel:+905400099737" className="text-primary-600 text-[16px] font-[300] cursor-pointer underline">
                 +90 54 000 99 737
                </Link>
            </div>
            ...
            <div className="flex flex-row gap-4 sm:gap-[45px] mt-4">
                ...
                <Link href="mailto:info@seramikimplant.com" className="text-primary-600 text-[16px] font-[300] cursor-pointer underline">
                info@seramikimplant.com
                </Link>
            </div>
